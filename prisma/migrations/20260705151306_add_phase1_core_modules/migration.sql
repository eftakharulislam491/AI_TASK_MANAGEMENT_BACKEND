...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'TASK_STATUS_CHANGED', 'TASK_COMMENT', 'TASK_DEADLINE_APPROACHING', 'TASK_OVERDUE', 'PROJECT_MEMBER_ADDED', 'TEAM_MEMBER_ADDED', 'INVITATION_RECEIVED', 'ROLE_CHANGED', 'MENTION');

-- CreateEnum
CREATE TYPE "AttachmentEntityType" AS ENUM ('TASK', 'COMMENT', 'PROJECT');
